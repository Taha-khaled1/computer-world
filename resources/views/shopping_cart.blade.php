            ...
            <div class="row no-gutters">
                    ...
                    <div class="product-details mr-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                            ...
                            <div class="d-flex flex-row">
                                <img class="rounded" src="{{ asset('img/' . $products->image) }}" width="40">
                                <div class="ml-2"><span
                                        class="font-weight-bold d-block">{{ $products->name }}</span><span
                                        class="spec">{{ $products->dis }}</span></div>
                            </div>
                            <div class="d-flex flex-row align-items-center">
                                <span class="d-block ml-5 font-weight-bold">{{ $products->price }}</span><i
                ...
                <div class="col-md-4">
                    <div class="payment-info">
                        ...
                        <a href="{{ route('stripe.post', $products->id) }}">
                            <label class="radio"><span><img
                                        width="30"
                            ...
                            <a href="{{ route('make.payment', $products->id) }}"><label class="radio"> <span><img
                                            width="30"
