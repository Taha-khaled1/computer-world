    ...
    <div class="header bg-c-black">
        ...
        <div class="floatright divsearch">
            ...
            {{-- <input type="text" class="inputsearch" >
             --}}
            <form action="{{ route('search_pro') }}" method="get">
                @csrf
                <label class="labelsearch">أبحث في الموقع :</label>


                <input type="text" placeholder="أبحث هنا" name="search" class="inputsearch" required>
                <input type="submit" class="search" value="إبحث">
                ...
                @if ($we->allaw == 1)
                    <div class="w3-third">
                        <div class="w3-container">
                            ...
                            <a href="{{ route('shoping', $we->id) }}"><button class="w3-btn-block bgred">إضافة إلى
                                    السلة + </button></a>
                        </div>
                    </div>
                @endif
